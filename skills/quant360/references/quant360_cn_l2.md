...
| `Amt` | Float | Trade notional value (CNY), or `0.000` for cancellations |
| `ExecType` | String | Event type: `F`=Fill (trade), `4`=Cancel (withdrawal) |
| `TransactTime` | Long | Exchange timestamp: `YYYYMMDDHHMMSSmmm` |
...
**Early Morning Data (09:15 - 09:30):**
During the pre-open and opening auction phases, the data contains predominantly `ExecType='4'` (cancel) events as orders are rejected or withdrawn. Actual trades (`ExecType='F'`) are relatively rare until the continuous trading session begins at 09:30.

Example pattern:
```
# 09:15 - mostly cancels
09:15:00, 33565, ..., ExecType='4', ...  # Cancel
09:15:05, 53475, ..., ExecType='4', ...  # Cancel

# 09:30 onwards - mostly fills
09:30:01, 12345, ..., ExecType='F', ...  # Trade fill
```
